...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('django_verispeak_learningprocess', 'retrain_model', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['django_verispeak.SpeakerModel'], null=True, blank=True), keep_default=False)

        # Adding field 'LearningProcess.result_model'
        db.add_column('django_verispeak_learningprocess', 'result_model', self.gf('django.db.models.fields.related.OneToOneField')(blank=True, related_name='learning_process', unique=True, null=True, to=orm['django_verispeak.SpeakerModel']), keep_default=False)

        # Deleting field 'SpeakerModel.learning_process'
        db.delete_column('django_verispeak_speakermodel', 'learning_process_id')


    def backwards(self, orm):
        
        # Deleting field 'LearningProcess.retrain_model'
        db.delete_column('django_verispeak_learningprocess', 'retrain_model_id')

        # Deleting field 'LearningProcess.result_model'
        db.delete_column('django_verispeak_learningprocess', 'result_model_id')

        # Adding field 'SpeakerModel.learning_process'
        db.add_column('django_verispeak_speakermodel', 'learning_process', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['django_verispeak.LearningProcess'], unique=True, null=True, blank=True), keep_default=False)
