...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'LLRVerificator.null_estimator'
        db.alter_column('voice_llrverificator', 'null_estimator_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['voice.SpeakerModel'], unique=True))

        # Adding unique constraint on 'LLRVerificator', fields ['null_estimator']
        db.create_unique('voice_llrverificator', ['null_estimator_id'])


    def backwards(self, orm):
        
        # Changing field 'LLRVerificator.null_estimator'
        db.alter_column('voice_llrverificator', 'null_estimator_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['voice.SpeakerModel']))

        # Removing unique constraint on 'LLRVerificator', fields ['null_estimator']
        db.delete_unique('voice_llrverificator', ['null_estimator_id'])
